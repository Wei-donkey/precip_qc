# -*- coding: utf-8 -*-
"""
Validate precipitation spatial consistency quality control.

Applies outlier and extreme circle checks to validation records,
labeling events and saving results with qc_label column.
"""
...
DATASET = 'test'  # run this script on "train" data or "test" data.
...
OUTPUT_FILE = DATA_DIR / f"qc_result_{DATASET}_outlier{OUTLIER_CIRCLES_RADIUS}km_extreme{EXTREME_CIRCLES_RADIUS}km.csv"
OUTPUT_COUNT = DATA_DIR / f"qc_count_{DATASET}_outlier{OUTLIER_CIRCLES_RADIUS}km_extreme{EXTREME_CIRCLES_RADIUS}km.csv"
OUTPUT_STATISTICS = DATA_DIR / f"qc_stats_{DATASET}_outlier{OUTLIER_CIRCLES_RADIUS}km_extreme{EXTREME_CIRCLES_RADIUS}km.csv"
